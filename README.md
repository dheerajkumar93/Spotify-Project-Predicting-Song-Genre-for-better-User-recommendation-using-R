...
The data was collected from the following URL - https://github.com/rfordatascience/tidytuesday/tree/master/data/2020/2020-01-21
...
As music is loved by everyone around the world, a Spotify user will always be interested in getting recommendations on specific genre types that they frequently listen to. And as Spotify is concerned with improving the user experience, providing better recommendations to the end user will help in improving customer satisfaction. Hence, through this project we are trying to predict the genre of a song based on the audio features.
